const CACHE_NAME = "ppr-v807-manual-repeats";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v807-manual-repeats",
  "./modules/repeat-failures.css?v=v807-manual-repeats",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v807-manual-repeats",
  "./modules/repeat-failures.js?v=v807-manual-repeats",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v807-manual-repeats",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v807-manual-repeats",
  "./modules/photo-compression.js?v=v807-manual-repeats",
  "./app.min.js?v=v807-manual-repeats",
  "./node_modules/jsqr/dist/jsQR.js?v=v807-manual-repeats",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
