const CACHE_NAME = "ppr-v410-shgrp-separated-columns";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=410-shgrp-separated-columns",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=410-shgrp-separated-columns",
  "./node_modules/mammoth/mammoth.browser.min.js?v=410-shgrp-separated-columns",
  "./modules/work-permit.js?v=410-shgrp-separated-columns",
  "./app.js?v=410-shgrp-separated-columns",
