const CACHE_NAME = "ppr-v751-current-shift-counter-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v751-current-shift-counter-1",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./node_modules/html2canvas/dist/html2canvas.min.js?v=v751-current-shift-counter-1",
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v751-current-shift-counter-1",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v751-current-shift-counter-1",
  "./node_modules/mammoth/mammoth.browser.min.js?v=v751-current-shift-counter-1",
  "./modules/work-permit.js?v=658-cleanup",
  "./app.js?v=v751-current-shift-counter-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v751-current-shift-counter-1",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
