const CACHE_NAME = "ppr-v795-monitor-without-state-clones";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v795-monitor-without-state-clones",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v795-monitor-without-state-clones",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v795-monitor-without-state-clones",
  "./modules/photo-compression.js?v=v795-monitor-without-state-clones",
  "./app.min.js?v=v795-monitor-without-state-clones",
  "./node_modules/jsqr/dist/jsQR.js?v=v795-monitor-without-state-clones",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
