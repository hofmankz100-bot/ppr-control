const CACHE_NAME = "ppr-v812-repeat-cycles";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v812-repeat-cycles",
  "./modules/repeat-failures.css?v=v812-repeat-cycles",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v812-repeat-cycles",
  "./modules/repeat-failures.js?v=v812-repeat-cycles",
  "./modules/aggregate-journal-view.js?v=v812-repeat-cycles",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v812-repeat-cycles",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v812-repeat-cycles",
  "./modules/photo-compression.js?v=v812-repeat-cycles",
  "./app.min.js?v=v812-repeat-cycles",
  "./node_modules/jsqr/dist/jsQR.js?v=v812-repeat-cycles",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
