const CACHE_NAME = "ppr-v524-crane-qr-role-access";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=524-crane-qr-role-access",
  ...
  "./app.js?v=524-crane-qr-role-access",
  "./node_modules/jsqr/dist/jsQR.js?v=v524-crane-qr-role-access",
