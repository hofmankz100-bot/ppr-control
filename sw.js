const CACHE_NAME = "ppr-v817-text-recovery";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v817-text-recovery",
  "./modules/repeat-failures.css?v=v817-text-recovery",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v817-text-recovery",
  "./modules/repeat-failures.js?v=v817-text-recovery",
  "./modules/aggregate-journal-view.js?v=v817-text-recovery",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v817-text-recovery",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v817-text-recovery",
  "./modules/photo-compression.js?v=v817-text-recovery",
  "./app.min.js?v=v817-text-recovery",
  "./node_modules/jsqr/dist/jsQR.js?v=v817-text-recovery",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
