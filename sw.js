const CACHE_NAME = "ppr-v794-monitor-without-state-write";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v794-monitor-without-state-write",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v794-monitor-without-state-write",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v794-monitor-without-state-write",
  "./modules/photo-compression.js?v=v794-monitor-without-state-write",
  "./app.min.js?v=v794-monitor-without-state-write",
  "./node_modules/jsqr/dist/jsQR.js?v=v794-monitor-without-state-write",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
