const CACHE_NAME = "ppr-v377-separated-walks";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=377-separated-walks",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=377-separated-walks",
  "./node_modules/mammoth/mammoth.browser.min.js?v=377-separated-walks",
  "./modules/work-permit.js?v=377-separated-walks",
  "./app.js?v=377-separated-walks",
