...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v873",
  "./modules/repeat-failures.css?v=v873",
  "./modules/ppr-plan-editor.css?v=v873",
  "./modules/ppr-plan-editor.js?v=v873",
  "./modules/compressor.js?v=v873",
  "./modules/shgrp.js?v=v873",
  "./modules/comments.js?v=v873",
  "./modules/repeat-failures.js?v=v873",
  "./modules/aggregate-journal-view.js?v=v873",
  "./modules/director.js?v=v873",
  "./modules/print-assets.js?v=v873",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v873",
  "./modules/photo-compression.js?v=v873",
  "./modules/attendance-entry.js?v=v873",
  "./modules/app-updater.js?v=v873",
  "./app.min.js?v=v873",
  "./node_modules/jsqr/dist/jsQR.js?v=v873",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
