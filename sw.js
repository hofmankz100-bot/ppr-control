const CACHE_NAME = "ppr-v349-work-permit-clean-print";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=349-work-permit-clean-print",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=349-work-permit-clean-print",
  "./node_modules/mammoth/mammoth.browser.min.js?v=349-work-permit-clean-print",
  "./modules/work-permit.js?v=349-work-permit-clean-print",
  "./app.js?v=349-work-permit-clean-print",
