const CACHE_NAME = "ppr-v814-ppr-labels";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v814-ppr-labels",
  "./modules/repeat-failures.css?v=v814-ppr-labels",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v814-ppr-labels",
  "./modules/repeat-failures.js?v=v814-ppr-labels",
  "./modules/aggregate-journal-view.js?v=v814-ppr-labels",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v814-ppr-labels",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v814-ppr-labels",
  "./modules/photo-compression.js?v=v814-ppr-labels",
  "./app.min.js?v=v814-ppr-labels",
  "./node_modules/jsqr/dist/jsQR.js?v=v814-ppr-labels",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
