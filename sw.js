const CACHE_NAME = "ppr-v819-ppr-work-template";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v819-ppr-work-template",
  "./modules/repeat-failures.css?v=v819-ppr-work-template",
  "./modules/ppr-plan-editor.css?v=v819-ppr-work-template",
  "./modules/ppr-plan-editor.js?v=v819-ppr-work-template",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v819-ppr-work-template",
  "./modules/repeat-failures.js?v=v819-ppr-work-template",
  "./modules/aggregate-journal-view.js?v=v819-ppr-work-template",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v819-ppr-work-template",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v819-ppr-work-template",
  "./modules/photo-compression.js?v=v819-ppr-work-template",
  "./app.min.js?v=v819-ppr-work-template",
  "./node_modules/jsqr/dist/jsQR.js?v=v819-ppr-work-template",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
