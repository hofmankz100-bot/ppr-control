const CACHE_NAME = "ppr-v815-measures-authors";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v815-measures-authors",
  "./modules/repeat-failures.css?v=v815-measures-authors",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v815-measures-authors",
  "./modules/repeat-failures.js?v=v815-measures-authors",
  "./modules/aggregate-journal-view.js?v=v815-measures-authors",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v815-measures-authors",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v815-measures-authors",
  "./modules/photo-compression.js?v=v815-measures-authors",
  "./app.min.js?v=v815-measures-authors",
  "./node_modules/jsqr/dist/jsQR.js?v=v815-measures-authors",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
