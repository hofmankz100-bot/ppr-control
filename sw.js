const CACHE_NAME = "ppr-v350-work-permit-mobile-sequence";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=350-work-permit-mobile-sequence",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=350-work-permit-mobile-sequence",
  "./node_modules/mammoth/mammoth.browser.min.js?v=350-work-permit-mobile-sequence",
  "./modules/work-permit.js?v=350-work-permit-mobile-sequence",
  "./app.js?v=350-work-permit-mobile-sequence",
