const CACHE_NAME = "ppr-v411-permit-instruction-ack";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=411-permit-instruction-ack",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=411-permit-instruction-ack",
  "./node_modules/mammoth/mammoth.browser.min.js?v=411-permit-instruction-ack",
  "./modules/work-permit.js?v=411-permit-instruction-ack",
  "./app.js?v=411-permit-instruction-ack",
