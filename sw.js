const CACHE_NAME = "ppr-v357-admin-audit-trash";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=357-admin-audit-trash",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=357-admin-audit-trash",
  "./node_modules/mammoth/mammoth.browser.min.js?v=357-admin-audit-trash",
  "./modules/work-permit.js?v=357-admin-audit-trash",
  "./app.js?v=357-admin-audit-trash",
