const CACHE_NAME = "ppr-v387-safe-node-delete";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=387-safe-node-delete",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=387-safe-node-delete",
  "./node_modules/mammoth/mammoth.browser.min.js?v=387-safe-node-delete",
  "./modules/work-permit.js?v=387-safe-node-delete",
  "./app.js?v=387-safe-node-delete",
