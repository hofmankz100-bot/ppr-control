const CACHE_NAME = "ppr-v401-admin-reliability";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=401-admin-reliability",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=401-admin-reliability",
  "./node_modules/mammoth/mammoth.browser.min.js?v=401-admin-reliability",
  "./modules/work-permit.js?v=401-admin-reliability",
  "./app.js?v=401-admin-reliability",
