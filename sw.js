const CACHE_NAME = "ppr-v385-mobile-date-cleanup";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=385-mobile-date-cleanup",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=385-mobile-date-cleanup",
  "./node_modules/mammoth/mammoth.browser.min.js?v=385-mobile-date-cleanup",
  "./modules/work-permit.js?v=385-mobile-date-cleanup",
  "./app.js?v=385-mobile-date-cleanup",
