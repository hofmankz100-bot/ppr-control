const CACHE_NAME = "ppr-v407-shgrp-grp-parentheses";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=407-shgrp-grp-parentheses",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=407-shgrp-grp-parentheses",
  "./node_modules/mammoth/mammoth.browser.min.js?v=407-shgrp-grp-parentheses",
  "./modules/work-permit.js?v=407-shgrp-grp-parentheses",
  "./app.js?v=407-shgrp-grp-parentheses",
