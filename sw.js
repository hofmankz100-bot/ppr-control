const CACHE_NAME = "ppr-v826-compact-ui";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v826-compact-ui",
  "./modules/repeat-failures.css?v=v826-compact-ui",
  "./modules/ppr-plan-editor.css?v=v826-compact-ui",
  "./modules/ppr-plan-editor.js?v=v826-compact-ui",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v826-compact-ui",
  "./modules/repeat-failures.js?v=v826-compact-ui",
  "./modules/aggregate-journal-view.js?v=v826-compact-ui",
  "./modules/director.js?v=v826-compact-ui",
  "./modules/print-assets.js?v=v826-compact-ui",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v826-compact-ui",
  "./modules/photo-compression.js?v=v826-compact-ui",
  "./modules/attendance-entry.js?v=v826-compact-ui",
  "./app.min.js?v=v826-compact-ui",
  "./node_modules/jsqr/dist/jsQR.js?v=v826-compact-ui",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
