const CACHE_NAME = "ppr-v366-admin-access";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=366-admin-access",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=366-admin-access",
  "./node_modules/mammoth/mammoth.browser.min.js?v=366-admin-access",
  "./modules/work-permit.js?v=366-admin-access",
  "./app.js?v=366-admin-access",
