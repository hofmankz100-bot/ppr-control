const CACHE_NAME = "ppr-v810-journal-scroll";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v810-journal-scroll",
  "./modules/repeat-failures.css?v=v810-journal-scroll",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v810-journal-scroll",
  "./modules/repeat-failures.js?v=v810-journal-scroll",
  "./modules/aggregate-journal-view.js?v=v810-journal-scroll",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v810-journal-scroll",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v810-journal-scroll",
  "./modules/photo-compression.js?v=v810-journal-scroll",
  "./app.min.js?v=v810-journal-scroll",
  "./node_modules/jsqr/dist/jsQR.js?v=v810-journal-scroll",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
