...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v846-zero-unused-code",
  "./modules/repeat-failures.css?v=v846-zero-unused-code",
  "./modules/ppr-plan-editor.css?v=v846-zero-unused-code",
  "./modules/ppr-plan-editor.js?v=v846-zero-unused-code",
  "./modules/compressor.js?v=v846-zero-unused-code",
  "./modules/shgrp.js?v=v846-zero-unused-code",
  "./modules/comments.js?v=v846-zero-unused-code",
  "./modules/repeat-failures.js?v=v846-zero-unused-code",
  "./modules/aggregate-journal-view.js?v=v846-zero-unused-code",
  "./modules/director.js?v=v846-zero-unused-code",
  "./modules/print-assets.js?v=v846-zero-unused-code",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v846-zero-unused-code",
  "./modules/photo-compression.js?v=v846-zero-unused-code",
  "./modules/attendance-entry.js?v=v846-zero-unused-code",
  "./modules/app-updater.js?v=v846-zero-unused-code",
  "./app.min.js?v=v846-zero-unused-code",
  "./node_modules/jsqr/dist/jsQR.js?v=v846-zero-unused-code",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
