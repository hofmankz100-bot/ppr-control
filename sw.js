const CACHE_NAME = "ppr-v820-quiet-sync-notice";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v820-quiet-sync-notice",
  "./modules/repeat-failures.css?v=v820-quiet-sync-notice",
  "./modules/ppr-plan-editor.css?v=v820-quiet-sync-notice",
  "./modules/ppr-plan-editor.js?v=v820-quiet-sync-notice",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v820-quiet-sync-notice",
  "./modules/repeat-failures.js?v=v820-quiet-sync-notice",
  "./modules/aggregate-journal-view.js?v=v820-quiet-sync-notice",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v820-quiet-sync-notice",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v820-quiet-sync-notice",
  "./modules/photo-compression.js?v=v820-quiet-sync-notice",
  "./app.min.js?v=v820-quiet-sync-notice",
  "./node_modules/jsqr/dist/jsQR.js?v=v820-quiet-sync-notice",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
