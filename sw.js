const CACHE_NAME = "ppr-v346-work-permit-manual-events";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=346-work-permit-manual-events",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=346-work-permit-manual-events",
  "./node_modules/mammoth/mammoth.browser.min.js?v=346-work-permit-manual-events",
  "./modules/work-permit.js?v=346-work-permit-manual-events",
  "./app.js?v=346-work-permit-manual-events",
