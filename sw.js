...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v847-clean-public-apis",
  "./modules/repeat-failures.css?v=v847-clean-public-apis",
  "./modules/ppr-plan-editor.css?v=v847-clean-public-apis",
  "./modules/ppr-plan-editor.js?v=v847-clean-public-apis",
  "./modules/compressor.js?v=v847-clean-public-apis",
  "./modules/shgrp.js?v=v847-clean-public-apis",
  "./modules/comments.js?v=v847-clean-public-apis",
  "./modules/repeat-failures.js?v=v847-clean-public-apis",
  "./modules/aggregate-journal-view.js?v=v847-clean-public-apis",
  "./modules/director.js?v=v847-clean-public-apis",
  "./modules/print-assets.js?v=v847-clean-public-apis",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v847-clean-public-apis",
  "./modules/photo-compression.js?v=v847-clean-public-apis",
  "./modules/attendance-entry.js?v=v847-clean-public-apis",
  "./modules/app-updater.js?v=v847-clean-public-apis",
  "./app.min.js?v=v847-clean-public-apis",
  "./node_modules/jsqr/dist/jsQR.js?v=v847-clean-public-apis",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
