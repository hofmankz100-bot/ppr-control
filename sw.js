const CACHE_NAME = "ppr-v559-clean-journal-output";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v559-clean-journal-output",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v559-clean-journal-output",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v559-clean-journal-output",
  ...
  "./app.js?v=v559-clean-journal-output",
  "./node_modules/jsqr/dist/jsQR.js?v=v559-clean-journal-output",
