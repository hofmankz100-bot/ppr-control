const CACHE_NAME = "ppr-v417-annual-ppr-pdf";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=417-annual-ppr-pdf",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=417-annual-ppr-pdf",
  "./node_modules/mammoth/mammoth.browser.min.js?v=417-annual-ppr-pdf",
  "./modules/work-permit.js?v=417-annual-ppr-pdf",
  "./app.js?v=417-annual-ppr-pdf",
