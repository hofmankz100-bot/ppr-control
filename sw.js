const CACHE_NAME = "ppr-v793-memory-hot-path";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v793-memory-hot-path",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v793-memory-hot-path",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v793-memory-hot-path",
  "./modules/photo-compression.js?v=v793-memory-hot-path",
  "./app.min.js?v=v793-memory-hot-path",
  "./node_modules/jsqr/dist/jsQR.js?v=v793-memory-hot-path",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
