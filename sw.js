const CACHE_NAME = "ppr-v408-shgrp-journal-layout";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=408-shgrp-journal-layout",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=408-shgrp-journal-layout",
  "./node_modules/mammoth/mammoth.browser.min.js?v=408-shgrp-journal-layout",
  "./modules/work-permit.js?v=408-shgrp-journal-layout",
  "./app.js?v=408-shgrp-journal-layout",
