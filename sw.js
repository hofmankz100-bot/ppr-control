const CACHE_NAME = "ppr-v358-system-monitoring";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=358-system-monitoring",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=358-system-monitoring",
  "./node_modules/mammoth/mammoth.browser.min.js?v=358-system-monitoring",
  "./modules/work-permit.js?v=358-system-monitoring",
  "./app.js?v=358-system-monitoring",
