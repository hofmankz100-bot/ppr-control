const CACHE_NAME = "ppr-v360-admin-backups";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=360-admin-backups",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=360-admin-backups",
  "./node_modules/mammoth/mammoth.browser.min.js?v=360-admin-backups",
  "./modules/work-permit.js?v=360-admin-backups",
  "./app.js?v=360-admin-backups",
