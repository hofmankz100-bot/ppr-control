const CACHE_NAME = "ppr-v541-equipment-trash";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v541-equipment-trash",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v541-equipment-trash",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v541-equipment-trash",
  ...
  "./app.js?v=v541-equipment-trash",
  "./node_modules/jsqr/dist/jsQR.js?v=v541-equipment-trash",
