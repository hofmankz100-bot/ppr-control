const CACHE_NAME = "ppr-v413-permanent-attendance-qr";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=413-permanent-attendance-qr",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=413-permanent-attendance-qr",
  "./node_modules/mammoth/mammoth.browser.min.js?v=413-permanent-attendance-qr",
  "./modules/work-permit.js?v=413-permanent-attendance-qr",
  "./app.js?v=413-permanent-attendance-qr",
