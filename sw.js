const CACHE_NAME = "ppr-v829-ppr-groups";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v829-ppr-groups",
  "./modules/repeat-failures.css?v=v829-ppr-groups",
  "./modules/ppr-plan-editor.css?v=v829-ppr-groups",
  "./modules/ppr-plan-editor.js?v=v829-ppr-groups",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v829-ppr-groups",
  "./modules/repeat-failures.js?v=v829-ppr-groups",
  "./modules/aggregate-journal-view.js?v=v829-ppr-groups",
  "./modules/director.js?v=v829-ppr-groups",
  "./modules/print-assets.js?v=v829-ppr-groups",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v829-ppr-groups",
  "./modules/photo-compression.js?v=v829-ppr-groups",
  "./modules/attendance-entry.js?v=v829-ppr-groups",
  "./app.min.js?v=v829-ppr-groups",
  "./node_modules/jsqr/dist/jsQR.js?v=v829-ppr-groups",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
