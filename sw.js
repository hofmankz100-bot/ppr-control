...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v856",
  "./modules/repeat-failures.css?v=v856",
  "./modules/ppr-plan-editor.css?v=v856",
  "./modules/ppr-plan-editor.js?v=v856",
  "./modules/compressor.js?v=v856",
  "./modules/shgrp.js?v=v856",
  "./modules/comments.js?v=v856",
  "./modules/repeat-failures.js?v=v856",
  "./modules/aggregate-journal-view.js?v=v856",
  "./modules/director.js?v=v856",
  "./modules/print-assets.js?v=v856",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v856",
  "./modules/photo-compression.js?v=v856",
  "./modules/attendance-entry.js?v=v856",
  "./modules/app-updater.js?v=v856",
  "./app.min.js?v=v856",
  "./node_modules/jsqr/dist/jsQR.js?v=v856",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
