const CACHE_NAME = "ppr-v364-admin-archives";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=364-admin-archives",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=364-admin-archives",
  "./node_modules/mammoth/mammoth.browser.min.js?v=364-admin-archives",
  "./modules/work-permit.js?v=364-admin-archives",
  "./app.js?v=364-admin-archives",
