const CACHE_NAME = "ppr-v811-repeat-measures";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v811-repeat-measures",
  "./modules/repeat-failures.css?v=v811-repeat-measures",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v811-repeat-measures",
  "./modules/repeat-failures.js?v=v811-repeat-measures",
  "./modules/aggregate-journal-view.js?v=v811-repeat-measures",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v811-repeat-measures",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v811-repeat-measures",
  "./modules/photo-compression.js?v=v811-repeat-measures",
  "./app.min.js?v=v811-repeat-measures",
  "./node_modules/jsqr/dist/jsQR.js?v=v811-repeat-measures",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
