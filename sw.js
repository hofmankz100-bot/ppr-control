const CACHE_NAME = "ppr-v543-no-score-journal";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v543-no-score-journal",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v543-no-score-journal",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v543-no-score-journal",
  ...
  "./app.js?v=v543-no-score-journal",
  "./node_modules/jsqr/dist/jsQR.js?v=v543-no-score-journal",
