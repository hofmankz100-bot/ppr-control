const CACHE_NAME = "ppr-v348-work-permit-official-print";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=348-work-permit-official-print",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=348-work-permit-official-print",
  "./node_modules/mammoth/mammoth.browser.min.js?v=348-work-permit-official-print",
  "./modules/work-permit.js?v=348-work-permit-official-print",
  "./app.js?v=348-work-permit-official-print",
