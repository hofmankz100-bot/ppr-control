const CACHE_NAME = "ppr-v786-photo-memory-3";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v786-photo-memory-3",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v786-photo-memory-3",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v786-photo-memory-3",
  "./modules/photo-compression.js?v=v786-photo-memory-3",
  "./app.min.js?v=v786-photo-memory-3",
  "./node_modules/jsqr/dist/jsQR.js?v=v786-photo-memory-3",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
