const CACHE_NAME = "ppr-v354-work-permit-offline-safe";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=354-work-permit-offline-safe",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=354-work-permit-offline-safe",
  "./node_modules/mammoth/mammoth.browser.min.js?v=354-work-permit-offline-safe",
  "./modules/work-permit.js?v=354-work-permit-offline-safe",
  "./app.js?v=354-work-permit-offline-safe",
