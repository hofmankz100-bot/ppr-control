const CACHE_NAME = "ppr-v468-admin-data-fast-load";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=468-admin-data-fast-load",
  ...
  "./modules/work-permit.js?v=468-admin-data-fast-load",
  "./app.js?v=468-admin-data-fast-load",
