const CACHE_NAME = "ppr-v593-fast-admin-access-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v593-fast-admin-access-1",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v593-fast-admin-access-1",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v593-fast-admin-access-1",
  ...
  "./app.js?v=v593-fast-admin-access-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v593-fast-admin-access-1",
