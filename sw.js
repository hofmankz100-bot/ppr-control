...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v845-app-code-cleanup",
  "./modules/repeat-failures.css?v=v845-app-code-cleanup",
  "./modules/ppr-plan-editor.css?v=v845-app-code-cleanup",
  "./modules/ppr-plan-editor.js?v=v845-app-code-cleanup",
  "./modules/compressor.js?v=v845-app-code-cleanup",
  "./modules/shgrp.js?v=v845-app-code-cleanup",
  "./modules/comments.js?v=v845-app-code-cleanup",
  "./modules/repeat-failures.js?v=v845-app-code-cleanup",
  "./modules/aggregate-journal-view.js?v=v845-app-code-cleanup",
  "./modules/director.js?v=v845-app-code-cleanup",
  "./modules/print-assets.js?v=v845-app-code-cleanup",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v845-app-code-cleanup",
  "./modules/photo-compression.js?v=v845-app-code-cleanup",
  "./modules/attendance-entry.js?v=v845-app-code-cleanup",
  "./modules/app-updater.js?v=v845-app-code-cleanup",
  "./app.min.js?v=v845-app-code-cleanup",
  "./node_modules/jsqr/dist/jsQR.js?v=v845-app-code-cleanup",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
