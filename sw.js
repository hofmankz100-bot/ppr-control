const CACHE_NAME = "ppr-v386-permit-button";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=386-permit-button",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=386-permit-button",
  "./node_modules/mammoth/mammoth.browser.min.js?v=386-permit-button",
  "./modules/work-permit.js?v=386-permit-button",
  "./app.js?v=386-permit-button",
