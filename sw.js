const CACHE_NAME = "ppr-v539-catalog-entity-sync";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v539-catalog-entity-sync",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v539-catalog-entity-sync",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v539-catalog-entity-sync",
  ...
  "./app.js?v=v539-catalog-entity-sync",
  "./node_modules/jsqr/dist/jsQR.js?v=v539-catalog-entity-sync",
