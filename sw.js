const CACHE_NAME = "ppr-v809-named-repeat-history";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v809-named-repeat-history",
  "./modules/repeat-failures.css?v=v809-named-repeat-history",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v809-named-repeat-history",
  "./modules/repeat-failures.js?v=v809-named-repeat-history",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v809-named-repeat-history",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v809-named-repeat-history",
  "./modules/photo-compression.js?v=v809-named-repeat-history",
  "./app.min.js?v=v809-named-repeat-history",
  "./node_modules/jsqr/dist/jsQR.js?v=v809-named-repeat-history",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
