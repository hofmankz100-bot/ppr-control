...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v862",
  "./modules/repeat-failures.css?v=v862",
  "./modules/ppr-plan-editor.css?v=v862",
  "./modules/ppr-plan-editor.js?v=v862",
  "./modules/compressor.js?v=v862",
  "./modules/shgrp.js?v=v862",
  "./modules/comments.js?v=v862",
  "./modules/repeat-failures.js?v=v862",
  "./modules/aggregate-journal-view.js?v=v862",
  "./modules/director.js?v=v862",
  "./modules/print-assets.js?v=v862",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v862",
  "./modules/photo-compression.js?v=v862",
  "./modules/attendance-entry.js?v=v862",
  "./modules/app-updater.js?v=v862",
  "./app.min.js?v=v862",
  "./node_modules/jsqr/dist/jsQR.js?v=v862",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
