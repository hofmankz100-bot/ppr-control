const CACHE_NAME = "ppr-v821-storage-qr-safety";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v821-storage-qr-safety",
  "./modules/repeat-failures.css?v=v821-storage-qr-safety",
  "./modules/ppr-plan-editor.css?v=v821-storage-qr-safety",
  "./modules/ppr-plan-editor.js?v=v821-storage-qr-safety",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v821-storage-qr-safety",
  "./modules/repeat-failures.js?v=v821-storage-qr-safety",
  "./modules/aggregate-journal-view.js?v=v821-storage-qr-safety",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v821-storage-qr-safety",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v821-storage-qr-safety",
  "./modules/photo-compression.js?v=v821-storage-qr-safety",
  "./app.min.js?v=v821-storage-qr-safety",
  "./node_modules/jsqr/dist/jsQR.js?v=v821-storage-qr-safety",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
