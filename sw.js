...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v853",
  "./modules/repeat-failures.css?v=v853",
  "./modules/ppr-plan-editor.css?v=v853",
  "./modules/ppr-plan-editor.js?v=v853",
  "./modules/compressor.js?v=v853",
  "./modules/shgrp.js?v=v853",
  "./modules/comments.js?v=v853",
  "./modules/repeat-failures.js?v=v853",
  "./modules/aggregate-journal-view.js?v=v853",
  "./modules/director.js?v=v853",
  "./modules/print-assets.js?v=v853",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v853",
  "./modules/photo-compression.js?v=v853",
  "./modules/attendance-entry.js?v=v853",
  "./modules/app-updater.js?v=v853",
  "./app.min.js?v=v853",
  "./node_modules/jsqr/dist/jsQR.js?v=v853",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
