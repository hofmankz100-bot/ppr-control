const CACHE_NAME = "ppr-v380-admin-mobile-fit";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=380-admin-mobile-fit",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=380-admin-mobile-fit",
  "./node_modules/mammoth/mammoth.browser.min.js?v=380-admin-mobile-fit",
  "./modules/work-permit.js?v=380-admin-mobile-fit",
  "./app.js?v=380-admin-mobile-fit",
