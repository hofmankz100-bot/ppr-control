...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v870",
  "./modules/repeat-failures.css?v=v870",
  "./modules/ppr-plan-editor.css?v=v870",
  "./modules/ppr-plan-editor.js?v=v870",
  "./modules/compressor.js?v=v870",
  "./modules/shgrp.js?v=v870",
  "./modules/comments.js?v=v870",
  "./modules/repeat-failures.js?v=v870",
  "./modules/aggregate-journal-view.js?v=v870",
  "./modules/director.js?v=v870",
  "./modules/print-assets.js?v=v870",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v870",
  "./modules/photo-compression.js?v=v870",
  "./modules/attendance-entry.js?v=v870",
  "./modules/app-updater.js?v=v870",
  "./app.min.js?v=v870",
  "./node_modules/jsqr/dist/jsQR.js?v=v870",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
