const CACHE_NAME = "ppr-v792-hide-session-notice";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v792-hide-session-notice",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v792-hide-session-notice",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v792-hide-session-notice",
  "./modules/photo-compression.js?v=v792-hide-session-notice",
  "./app.min.js?v=v792-hide-session-notice",
  "./node_modules/jsqr/dist/jsQR.js?v=v792-hide-session-notice",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
