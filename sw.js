...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v861",
  "./modules/repeat-failures.css?v=v861",
  "./modules/ppr-plan-editor.css?v=v861",
  "./modules/ppr-plan-editor.js?v=v861",
  "./modules/compressor.js?v=v861",
  "./modules/shgrp.js?v=v861",
  "./modules/comments.js?v=v861",
  "./modules/repeat-failures.js?v=v861",
  "./modules/aggregate-journal-view.js?v=v861",
  "./modules/director.js?v=v861",
  "./modules/print-assets.js?v=v861",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v861",
  "./modules/photo-compression.js?v=v861",
  "./modules/attendance-entry.js?v=v861",
  "./modules/app-updater.js?v=v861",
  "./app.min.js?v=v861",
  "./node_modules/jsqr/dist/jsQR.js?v=v861",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
