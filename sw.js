const CACHE_NAME = "ppr-v370-notification-control";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=370-notification-control",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=370-notification-control",
  "./node_modules/mammoth/mammoth.browser.min.js?v=370-notification-control",
  "./modules/work-permit.js?v=370-notification-control",
  "./app.js?v=370-notification-control",
