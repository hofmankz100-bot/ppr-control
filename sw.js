const CACHE_NAME = "ppr-v412-permit-ack-restore";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=412-permit-ack-restore",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=412-permit-ack-restore",
  "./node_modules/mammoth/mammoth.browser.min.js?v=412-permit-ack-restore",
  "./modules/work-permit.js?v=412-permit-ack-restore",
  "./app.js?v=412-permit-ack-restore",
