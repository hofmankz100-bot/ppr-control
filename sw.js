const CACHE_NAME = "ppr-v830-remove-work-permit";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v830-remove-work-permit",
  "./modules/repeat-failures.css?v=v830-remove-work-permit",
  "./modules/ppr-plan-editor.css?v=v830-remove-work-permit",
  "./modules/ppr-plan-editor.js?v=v830-remove-work-permit",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v830-remove-work-permit",
  "./modules/repeat-failures.js?v=v830-remove-work-permit",
  "./modules/aggregate-journal-view.js?v=v830-remove-work-permit",
  "./modules/director.js?v=v830-remove-work-permit",
  "./modules/print-assets.js?v=v830-remove-work-permit",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v830-remove-work-permit",
  "./modules/photo-compression.js?v=v830-remove-work-permit",
  "./modules/attendance-entry.js?v=v830-remove-work-permit",
  "./app.min.js?v=v830-remove-work-permit",
  "./node_modules/jsqr/dist/jsQR.js?v=v830-remove-work-permit",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
