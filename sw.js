const CACHE_NAME = "ppr-v608-remove-push-diagnostics-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v608-remove-push-diagnostics-1",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v608-remove-push-diagnostics-1",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v608-remove-push-diagnostics-1",
  ...
  "./app.js?v=v608-remove-push-diagnostics-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v608-remove-push-diagnostics-1",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
