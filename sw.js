const CACHE_NAME = "ppr-v356-qr-journal-access";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=356-qr-journal-access",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=356-qr-journal-access",
  "./node_modules/mammoth/mammoth.browser.min.js?v=356-qr-journal-access",
  "./modules/work-permit.js?v=356-qr-journal-access",
  "./app.js?v=356-qr-journal-access",
