const CACHE_NAME = "ppr-v561-mobile-node-actions";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v561-mobile-node-actions",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v561-mobile-node-actions",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v561-mobile-node-actions",
  ...
  "./app.js?v=v561-mobile-node-actions",
  "./node_modules/jsqr/dist/jsQR.js?v=v561-mobile-node-actions",
