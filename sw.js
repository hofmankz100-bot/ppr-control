const CACHE_NAME = "ppr-v373-admin-catalogs";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=373-admin-catalogs",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=373-admin-catalogs",
  "./node_modules/mammoth/mammoth.browser.min.js?v=373-admin-catalogs",
  "./modules/work-permit.js?v=373-admin-catalogs",
  "./app.js?v=373-admin-catalogs",
