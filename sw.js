const CACHE_NAME = "ppr-v418-annual-ppr-pdf-render";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=418-annual-ppr-pdf-render",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=418-annual-ppr-pdf-render",
  "./node_modules/mammoth/mammoth.browser.min.js?v=418-annual-ppr-pdf-render",
  "./modules/work-permit.js?v=418-annual-ppr-pdf-render",
  "./app.js?v=418-annual-ppr-pdf-render",
