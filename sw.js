const CACHE_NAME = "ppr-v363-admin-activity";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=363-admin-activity",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=363-admin-activity",
  "./node_modules/mammoth/mammoth.browser.min.js?v=363-admin-activity",
  "./modules/work-permit.js?v=363-admin-activity",
  "./app.js?v=363-admin-activity",
