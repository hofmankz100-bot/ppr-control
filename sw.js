const CACHE_NAME = "ppr-v538-ordered-node-actions";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v538-ordered-node-actions",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v538-ordered-node-actions",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v538-ordered-node-actions",
  ...
  "./app.js?v=v538-ordered-node-actions",
  "./node_modules/jsqr/dist/jsQR.js?v=v538-ordered-node-actions",
