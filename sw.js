...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v860",
  "./modules/repeat-failures.css?v=v860",
  "./modules/ppr-plan-editor.css?v=v860",
  "./modules/ppr-plan-editor.js?v=v860",
  "./modules/compressor.js?v=v860",
  "./modules/shgrp.js?v=v860",
  "./modules/comments.js?v=v860",
  "./modules/repeat-failures.js?v=v860",
  "./modules/aggregate-journal-view.js?v=v860",
  "./modules/director.js?v=v860",
  "./modules/print-assets.js?v=v860",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v860",
  "./modules/photo-compression.js?v=v860",
  "./modules/attendance-entry.js?v=v860",
  "./modules/app-updater.js?v=v860",
  "./app.min.js?v=v860",
  "./node_modules/jsqr/dist/jsQR.js?v=v860",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
