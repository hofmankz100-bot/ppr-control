const CACHE_NAME = "ppr-v367-admin-system-report";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=367-admin-system-report",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=367-admin-system-report",
  "./node_modules/mammoth/mammoth.browser.min.js?v=367-admin-system-report",
  "./modules/work-permit.js?v=367-admin-system-report",
  "./app.js?v=367-admin-system-report",
