const CACHE_NAME = "ppr-v404-shgrp-control-tubes";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=404-shgrp-control-tubes",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=404-shgrp-control-tubes",
  "./node_modules/mammoth/mammoth.browser.min.js?v=404-shgrp-control-tubes",
  "./modules/work-permit.js?v=404-shgrp-control-tubes",
  "./app.js?v=404-shgrp-control-tubes",
