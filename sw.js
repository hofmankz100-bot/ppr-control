const CACHE_NAME = "ppr-v369-admin-broadcasts";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=369-admin-broadcasts",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=369-admin-broadcasts",
  "./node_modules/mammoth/mammoth.browser.min.js?v=369-admin-broadcasts",
  "./modules/work-permit.js?v=369-admin-broadcasts",
  "./app.js?v=369-admin-broadcasts",
