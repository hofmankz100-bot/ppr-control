const CACHE_NAME = "ppr-v388-profile-cleanup";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=388-profile-cleanup",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=388-profile-cleanup",
  "./node_modules/mammoth/mammoth.browser.min.js?v=388-profile-cleanup",
  "./modules/work-permit.js?v=388-profile-cleanup",
  "./app.js?v=388-profile-cleanup",
