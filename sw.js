...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v875",
  "./modules/repeat-failures.css?v=v875",
  "./modules/ppr-plan-editor.css?v=v875",
  "./modules/ppr-plan-editor.js?v=v875",
  "./modules/compressor.js?v=v875",
  "./modules/shgrp.js?v=v875",
  "./modules/comments.js?v=v875",
  "./modules/repeat-failures.js?v=v875",
  "./modules/aggregate-journal-view.js?v=v875",
  "./modules/director.js?v=v875",
  "./modules/print-assets.js?v=v875",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v875",
  "./modules/photo-compression.js?v=v875",
  "./modules/attendance-entry.js?v=v875",
  "./modules/app-updater.js?v=v875",
  "./app.min.js?v=v875",
  "./node_modules/jsqr/dist/jsQR.js?v=v875",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
