...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v867",
  "./modules/repeat-failures.css?v=v867",
  "./modules/ppr-plan-editor.css?v=v867",
  "./modules/ppr-plan-editor.js?v=v867",
  "./modules/compressor.js?v=v867",
  "./modules/shgrp.js?v=v867",
  "./modules/comments.js?v=v867",
  "./modules/repeat-failures.js?v=v867",
  "./modules/aggregate-journal-view.js?v=v867",
  "./modules/director.js?v=v867",
  "./modules/print-assets.js?v=v867",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v867",
  "./modules/photo-compression.js?v=v867",
  "./modules/attendance-entry.js?v=v867",
  "./modules/app-updater.js?v=v867",
  "./app.min.js?v=v867",
  "./node_modules/jsqr/dist/jsQR.js?v=v867",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
