const CACHE_NAME = "ppr-v342-work-permit-safety-layout";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=342-work-permit-safety-layout",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=342-work-permit-safety-layout",
  "./node_modules/mammoth/mammoth.browser.min.js?v=342-work-permit-safety-layout",
  "./modules/work-permit.js?v=342-work-permit-safety-layout",
  "./app.js?v=342-work-permit-safety-layout",
