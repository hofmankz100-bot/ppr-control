const CACHE_NAME = "ppr-v402-shgrp-grp-qr";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=402-shgrp-grp-qr",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=402-shgrp-grp-qr",
  "./node_modules/mammoth/mammoth.browser.min.js?v=402-shgrp-grp-qr",
  "./modules/work-permit.js?v=402-shgrp-grp-qr",
  "./app.js?v=402-shgrp-grp-qr",
