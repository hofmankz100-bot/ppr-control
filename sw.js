...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v869",
  "./modules/repeat-failures.css?v=v869",
  "./modules/ppr-plan-editor.css?v=v869",
  "./modules/ppr-plan-editor.js?v=v869",
  "./modules/compressor.js?v=v869",
  "./modules/shgrp.js?v=v869",
  "./modules/comments.js?v=v869",
  "./modules/repeat-failures.js?v=v869",
  "./modules/aggregate-journal-view.js?v=v869",
  "./modules/director.js?v=v869",
  "./modules/print-assets.js?v=v869",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v869",
  "./modules/photo-compression.js?v=v869",
  "./modules/attendance-entry.js?v=v869",
  "./modules/app-updater.js?v=v869",
  "./app.min.js?v=v869",
  "./node_modules/jsqr/dist/jsQR.js?v=v869",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
