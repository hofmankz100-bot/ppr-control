const CACHE_NAME = "ppr-v778-restore-turning-shop-catalog-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v778-restore-turning-shop-catalog-1",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v778-restore-turning-shop-catalog-1",
  "./app.min.js?v=v778-restore-turning-shop-catalog-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v778-restore-turning-shop-catalog-1",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
