const CACHE_NAME = "ppr-v818-text-restored";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v818-text-restored",
  "./modules/repeat-failures.css?v=v818-text-restored",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v818-text-restored",
  "./modules/repeat-failures.js?v=v818-text-restored",
  "./modules/aggregate-journal-view.js?v=v818-text-restored",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v818-text-restored",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v818-text-restored",
  "./modules/photo-compression.js?v=v818-text-restored",
  "./app.min.js?v=v818-text-restored",
  "./node_modules/jsqr/dist/jsQR.js?v=v818-text-restored",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
