const CACHE_NAME = "ppr-v384-admin-technical-count";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=384-admin-technical-count",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=384-admin-technical-count",
  "./node_modules/mammoth/mammoth.browser.min.js?v=384-admin-technical-count",
  "./modules/work-permit.js?v=384-admin-technical-count",
  "./app.js?v=384-admin-technical-count",
