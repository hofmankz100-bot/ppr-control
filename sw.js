const CACHE_NAME = "ppr-v390-adlet-rating-cleanup";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=390-adlet-rating-cleanup",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=390-adlet-rating-cleanup",
  "./node_modules/mammoth/mammoth.browser.min.js?v=390-adlet-rating-cleanup",
  "./modules/work-permit.js?v=390-adlet-rating-cleanup",
  "./app.js?v=390-adlet-rating-cleanup",
