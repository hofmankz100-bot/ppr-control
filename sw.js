...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v854",
  "./modules/repeat-failures.css?v=v854",
  "./modules/ppr-plan-editor.css?v=v854",
  "./modules/ppr-plan-editor.js?v=v854",
  "./modules/compressor.js?v=v854",
  "./modules/shgrp.js?v=v854",
  "./modules/comments.js?v=v854",
  "./modules/repeat-failures.js?v=v854",
  "./modules/aggregate-journal-view.js?v=v854",
  "./modules/director.js?v=v854",
  "./modules/print-assets.js?v=v854",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v854",
  "./modules/photo-compression.js?v=v854",
  "./modules/attendance-entry.js?v=v854",
  "./modules/app-updater.js?v=v854",
  "./app.min.js?v=v854",
  "./node_modules/jsqr/dist/jsQR.js?v=v854",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
