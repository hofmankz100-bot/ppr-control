const CACHE_NAME = "ppr-v627-gpm-trash-live-sync-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v627-gpm-trash-live-sync-1",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v627-gpm-trash-live-sync-1",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v627-gpm-trash-live-sync-1",
  ...
  "./app.js?v=v627-gpm-trash-live-sync-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v627-gpm-trash-live-sync-1",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
