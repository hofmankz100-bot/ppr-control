const CACHE_NAME = "ppr-v351-work-permit-live-times";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=351-work-permit-live-times",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=351-work-permit-live-times",
  "./node_modules/mammoth/mammoth.browser.min.js?v=351-work-permit-live-times",
  "./modules/work-permit.js?v=351-work-permit-live-times",
  "./app.js?v=351-work-permit-live-times",
