const CACHE_NAME = "ppr-v361-admin-backup-timeout";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=361-admin-backup-timeout",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=361-admin-backup-timeout",
  "./node_modules/mammoth/mammoth.browser.min.js?v=361-admin-backup-timeout",
  "./modules/work-permit.js?v=361-admin-backup-timeout",
  "./app.js?v=361-admin-backup-timeout",
