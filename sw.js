const CACHE_NAME = "ppr-v676-crane-nested-admin-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v676-crane-nested-admin-1",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v676-crane-nested-admin-1",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v676-crane-nested-admin-1",
  "./node_modules/mammoth/mammoth.browser.min.js?v=421-annual-ppr-equipment-acts",
  "./modules/work-permit.js?v=658-cleanup",
  "./app.js?v=v676-crane-nested-admin-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v676-crane-nested-admin-1",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
