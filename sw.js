const CACHE_NAME = "ppr-v558-ios-whatsapp-pdf";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v558-ios-whatsapp-pdf",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v558-ios-whatsapp-pdf",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v558-ios-whatsapp-pdf",
  ...
  "./app.js?v=v558-ios-whatsapp-pdf",
  "./node_modules/jsqr/dist/jsQR.js?v=v558-ios-whatsapp-pdf",
