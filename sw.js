const CACHE_NAME = "ppr-v532-monthly-rating";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v532-monthly-rating",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v532-monthly-rating",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v532-monthly-rating",
  ...
  "./app.js?v=v532-monthly-rating",
  "./node_modules/jsqr/dist/jsQR.js?v=v532-monthly-rating",
