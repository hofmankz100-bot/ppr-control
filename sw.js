const CACHE_NAME = "ppr-v799-remark-deduplication";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v799-remark-deduplication",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=288-print-request-pages",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v799-remark-deduplication",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v799-remark-deduplication",
  "./modules/photo-compression.js?v=v799-remark-deduplication",
  "./app.min.js?v=v799-remark-deduplication",
  "./node_modules/jsqr/dist/jsQR.js?v=v799-remark-deduplication",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
