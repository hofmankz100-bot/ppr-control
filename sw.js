const CACHE_NAME = "ppr-v813-ppr-utf8";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v813-ppr-utf8",
  "./modules/repeat-failures.css?v=v813-ppr-utf8",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v813-ppr-utf8",
  "./modules/repeat-failures.js?v=v813-ppr-utf8",
  "./modules/aggregate-journal-view.js?v=v813-ppr-utf8",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v813-ppr-utf8",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v813-ppr-utf8",
  "./modules/photo-compression.js?v=v813-ppr-utf8",
  "./app.min.js?v=v813-ppr-utf8",
  "./node_modules/jsqr/dist/jsQR.js?v=v813-ppr-utf8",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
