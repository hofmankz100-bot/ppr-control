const CACHE_NAME = "ppr-v371-employee-cards";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=371-employee-cards",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=371-employee-cards",
  "./node_modules/mammoth/mammoth.browser.min.js?v=371-employee-cards",
  "./modules/work-permit.js?v=371-employee-cards",
  "./app.js?v=371-employee-cards",
