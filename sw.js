const CACHE_NAME = "ppr-v804-repeat-failure-journal";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v804-repeat-failure-journal",
  "./modules/repeat-failures.css?v=v804-repeat-failure-journal",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v804-repeat-failure-journal",
  "./modules/repeat-failures.js?v=v804-repeat-failure-journal",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v804-repeat-failure-journal",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v804-repeat-failure-journal",
  "./modules/photo-compression.js?v=v804-repeat-failure-journal",
  "./app.min.js?v=v804-repeat-failure-journal",
  "./node_modules/jsqr/dist/jsQR.js?v=v804-repeat-failure-journal",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
