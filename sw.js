const CACHE_NAME = "ppr-v805-repeat-failure-print-clean";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v805-repeat-failure-print-clean",
  "./modules/repeat-failures.css?v=v805-repeat-failure-print-clean",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v805-repeat-failure-print-clean",
  "./modules/repeat-failures.js?v=v805-repeat-failure-print-clean",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v805-repeat-failure-print-clean",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v805-repeat-failure-print-clean",
  "./modules/photo-compression.js?v=v805-repeat-failure-print-clean",
  "./app.min.js?v=v805-repeat-failure-print-clean",
  "./node_modules/jsqr/dist/jsQR.js?v=v805-repeat-failure-print-clean",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
