const CACHE_NAME = "ppr-v637-forklift-qr-print-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v637-forklift-qr-print-1",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v637-forklift-qr-print-1",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v637-forklift-qr-print-1",
  ...
  "./app.js?v=v637-forklift-qr-print-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v637-forklift-qr-print-1",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
