const CACHE_NAME = "ppr-v375-walk-counters";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=375-walk-counters",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=375-walk-counters",
  "./node_modules/mammoth/mammoth.browser.min.js?v=375-walk-counters",
  "./modules/work-permit.js?v=375-walk-counters",
  "./app.js?v=375-walk-counters",
