const CACHE_NAME = "ppr-v352-work-permit-mobile-pdf";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=352-work-permit-mobile-pdf",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=352-work-permit-mobile-pdf",
  "./node_modules/mammoth/mammoth.browser.min.js?v=352-work-permit-mobile-pdf",
  "./modules/work-permit.js?v=352-work-permit-mobile-pdf",
  "./app.js?v=352-work-permit-mobile-pdf",
