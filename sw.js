const CACHE_NAME = "ppr-v359-admin-editor";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=359-admin-editor",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=359-admin-editor",
  "./node_modules/mammoth/mammoth.browser.min.js?v=359-admin-editor",
  "./modules/work-permit.js?v=359-admin-editor",
  "./app.js?v=359-admin-editor",
