const CACHE_NAME = "ppr-v383-qr-server-status";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=383-qr-server-status",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=383-qr-server-status",
  "./node_modules/mammoth/mammoth.browser.min.js?v=383-qr-server-status",
  "./modules/work-permit.js?v=383-qr-server-status",
  "./app.js?v=383-qr-server-status",
