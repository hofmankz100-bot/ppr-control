const CACHE_NAME = "ppr-v806-repeat-failure-mobile-simple";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v806-repeat-failure-mobile-simple",
  "./modules/repeat-failures.css?v=v806-repeat-failure-mobile-simple",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v806-repeat-failure-mobile-simple",
  "./modules/repeat-failures.js?v=v806-repeat-failure-mobile-simple",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v806-repeat-failure-mobile-simple",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v806-repeat-failure-mobile-simple",
  "./modules/photo-compression.js?v=v806-repeat-failure-mobile-simple",
  "./app.min.js?v=v806-repeat-failure-mobile-simple",
  "./node_modules/jsqr/dist/jsQR.js?v=v806-repeat-failure-mobile-simple",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
