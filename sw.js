const CACHE_NAME = "ppr-v808-repeat-journal-styles";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v808-repeat-journal-styles",
  "./modules/repeat-failures.css?v=v808-repeat-journal-styles",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v808-repeat-journal-styles",
  "./modules/repeat-failures.js?v=v808-repeat-journal-styles",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v808-repeat-journal-styles",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v808-repeat-journal-styles",
  "./modules/photo-compression.js?v=v808-repeat-journal-styles",
  "./app.min.js?v=v808-repeat-journal-styles",
  "./node_modules/jsqr/dist/jsQR.js?v=v808-repeat-journal-styles",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
