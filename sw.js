const CACHE_NAME = "ppr-v828-repeat-repairs-kpd";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v828-repeat-repairs-kpd",
  "./modules/repeat-failures.css?v=v828-repeat-repairs-kpd",
  "./modules/ppr-plan-editor.css?v=v828-repeat-repairs-kpd",
  "./modules/ppr-plan-editor.js?v=v828-repeat-repairs-kpd",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v828-repeat-repairs-kpd",
  "./modules/repeat-failures.js?v=v828-repeat-repairs-kpd",
  "./modules/aggregate-journal-view.js?v=v828-repeat-repairs-kpd",
  "./modules/director.js?v=v828-repeat-repairs-kpd",
  "./modules/print-assets.js?v=v828-repeat-repairs-kpd",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v828-repeat-repairs-kpd",
  "./modules/photo-compression.js?v=v828-repeat-repairs-kpd",
  "./modules/attendance-entry.js?v=v828-repeat-repairs-kpd",
  "./app.min.js?v=v828-repeat-repairs-kpd",
  "./node_modules/jsqr/dist/jsQR.js?v=v828-repeat-repairs-kpd",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
