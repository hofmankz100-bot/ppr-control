const CACHE_NAME = "ppr-v374-qr-routes";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=374-qr-routes",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=374-qr-routes",
  "./node_modules/mammoth/mammoth.browser.min.js?v=374-qr-routes",
  "./modules/work-permit.js?v=374-qr-routes",
  "./app.js?v=374-qr-routes",
