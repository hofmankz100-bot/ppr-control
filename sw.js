const CACHE_NAME = "ppr-v823-realtime-push-safety";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v823-realtime-push-safety",
  "./modules/repeat-failures.css?v=v823-realtime-push-safety",
  "./modules/ppr-plan-editor.css?v=v823-realtime-push-safety",
  "./modules/ppr-plan-editor.js?v=v823-realtime-push-safety",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v823-realtime-push-safety",
  "./modules/repeat-failures.js?v=v823-realtime-push-safety",
  "./modules/aggregate-journal-view.js?v=v823-realtime-push-safety",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v823-realtime-push-safety",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v823-realtime-push-safety",
  "./modules/photo-compression.js?v=v823-realtime-push-safety",
  "./app.min.js?v=v823-realtime-push-safety",
  "./node_modules/jsqr/dist/jsQR.js?v=v823-realtime-push-safety",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
