const CACHE_NAME = "ppr-v537-single-node-qr-print";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v537-single-node-qr-print",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v537-single-node-qr-print",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v537-single-node-qr-print",
  ...
  "./app.js?v=v537-single-node-qr-print",
  "./node_modules/jsqr/dist/jsQR.js?v=v537-single-node-qr-print",
