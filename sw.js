const CACHE_NAME = "ppr-v381-qr-walk-persist";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=381-qr-walk-persist",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=381-qr-walk-persist",
  "./node_modules/mammoth/mammoth.browser.min.js?v=381-qr-walk-persist",
  "./modules/work-permit.js?v=381-qr-walk-persist",
  "./app.js?v=381-qr-walk-persist",
