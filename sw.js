...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v865",
  "./modules/repeat-failures.css?v=v865",
  "./modules/ppr-plan-editor.css?v=v865",
  "./modules/ppr-plan-editor.js?v=v865",
  "./modules/compressor.js?v=v865",
  "./modules/shgrp.js?v=v865",
  "./modules/comments.js?v=v865",
  "./modules/repeat-failures.js?v=v865",
  "./modules/aggregate-journal-view.js?v=v865",
  "./modules/director.js?v=v865",
  "./modules/print-assets.js?v=v865",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v865",
  "./modules/photo-compression.js?v=v865",
  "./modules/attendance-entry.js?v=v865",
  "./modules/app-updater.js?v=v865",
  "./app.min.js?v=v865",
  "./node_modules/jsqr/dist/jsQR.js?v=v865",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
