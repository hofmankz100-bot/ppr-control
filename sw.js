const CACHE_NAME = "ppr-v570-whatsapp-dark-theme";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v570-whatsapp-dark-theme",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v570-whatsapp-dark-theme",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v570-whatsapp-dark-theme",
  ...
  "./app.js?v=v570-whatsapp-dark-theme",
  "./node_modules/jsqr/dist/jsQR.js?v=v570-whatsapp-dark-theme",
