const CACHE_NAME = "ppr-v557-qr-mobile-viewport";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v557-qr-mobile-viewport",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v557-qr-mobile-viewport",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v557-qr-mobile-viewport",
  ...
  "./app.js?v=v557-qr-mobile-viewport",
  "./node_modules/jsqr/dist/jsQR.js?v=v557-qr-mobile-viewport",
