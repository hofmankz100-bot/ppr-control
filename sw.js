const CACHE_NAME = "ppr-v822-ppr-history-safety";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v822-ppr-history-safety",
  "./modules/repeat-failures.css?v=v822-ppr-history-safety",
  "./modules/ppr-plan-editor.css?v=v822-ppr-history-safety",
  "./modules/ppr-plan-editor.js?v=v822-ppr-history-safety",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v822-ppr-history-safety",
  "./modules/repeat-failures.js?v=v822-ppr-history-safety",
  "./modules/aggregate-journal-view.js?v=v822-ppr-history-safety",
  "./modules/director.js?v=288-print-request-pages",
  "./modules/print-assets.js?v=v822-ppr-history-safety",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v822-ppr-history-safety",
  "./modules/photo-compression.js?v=v822-ppr-history-safety",
  "./app.min.js?v=v822-ppr-history-safety",
  "./node_modules/jsqr/dist/jsQR.js?v=v822-ppr-history-safety",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
