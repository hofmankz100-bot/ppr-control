const CACHE_NAME = "ppr-v379-technical-walk-sync";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=379-technical-walk-sync",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=379-technical-walk-sync",
  "./node_modules/mammoth/mammoth.browser.min.js?v=379-technical-walk-sync",
  "./modules/work-permit.js?v=379-technical-walk-sync",
  "./app.js?v=379-technical-walk-sync",
