const CACHE_NAME = "ppr-v378-mobile-equipment";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=378-mobile-equipment",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=378-mobile-equipment",
  "./node_modules/mammoth/mammoth.browser.min.js?v=378-mobile-equipment",
  "./modules/work-permit.js?v=378-mobile-equipment",
  "./app.js?v=378-mobile-equipment",
