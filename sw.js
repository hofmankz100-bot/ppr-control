...
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v872",
  "./modules/repeat-failures.css?v=v872",
  "./modules/ppr-plan-editor.css?v=v872",
  "./modules/ppr-plan-editor.js?v=v872",
  "./modules/compressor.js?v=v872",
  "./modules/shgrp.js?v=v872",
  "./modules/comments.js?v=v872",
  "./modules/repeat-failures.js?v=v872",
  "./modules/aggregate-journal-view.js?v=v872",
  "./modules/director.js?v=v872",
  "./modules/print-assets.js?v=v872",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v872",
  "./modules/photo-compression.js?v=v872",
  "./modules/attendance-entry.js?v=v872",
  "./modules/app-updater.js?v=v872",
  "./app.min.js?v=v872",
  "./node_modules/jsqr/dist/jsQR.js?v=v872",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
