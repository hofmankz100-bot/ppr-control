const CACHE_NAME = "ppr-v376-mobile-walk-counters";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=376-mobile-walk-counters",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=376-mobile-walk-counters",
  "./node_modules/mammoth/mammoth.browser.min.js?v=376-mobile-walk-counters",
  "./modules/work-permit.js?v=376-mobile-walk-counters",
  "./app.js?v=376-mobile-walk-counters",
