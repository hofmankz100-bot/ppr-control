const CACHE_NAME = "ppr-v392-admin-guide";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=392-admin-guide",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=392-admin-guide",
  "./node_modules/mammoth/mammoth.browser.min.js?v=392-admin-guide",
  "./modules/work-permit.js?v=392-admin-guide",
  "./app.js?v=392-admin-guide",
