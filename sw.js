const CACHE_NAME = "ppr-v365-admin-automation";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=365-admin-automation",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=365-admin-automation",
  "./node_modules/mammoth/mammoth.browser.min.js?v=365-admin-automation",
  "./modules/work-permit.js?v=365-admin-automation",
  "./app.js?v=365-admin-automation",
