const CACHE_NAME = "ppr-v372-individual-permissions";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=372-individual-permissions",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=372-individual-permissions",
  "./node_modules/mammoth/mammoth.browser.min.js?v=372-individual-permissions",
  "./modules/work-permit.js?v=372-individual-permissions",
  "./app.js?v=372-individual-permissions",
