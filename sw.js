const CACHE_NAME = "ppr-v832-deep-code-audit";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v832-deep-code-audit",
  "./modules/repeat-failures.css?v=v832-deep-code-audit",
  "./modules/ppr-plan-editor.css?v=v832-deep-code-audit",
  "./modules/ppr-plan-editor.js?v=v832-deep-code-audit",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/comments.js?v=v832-deep-code-audit",
  "./modules/repeat-failures.js?v=v832-deep-code-audit",
  "./modules/aggregate-journal-view.js?v=v832-deep-code-audit",
  "./modules/director.js?v=v832-deep-code-audit",
  "./modules/print-assets.js?v=v832-deep-code-audit",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v832-deep-code-audit",
  "./modules/photo-compression.js?v=v832-deep-code-audit",
  "./modules/attendance-entry.js?v=v832-deep-code-audit",
  "./app.min.js?v=v832-deep-code-audit",
  "./node_modules/jsqr/dist/jsQR.js?v=v832-deep-code-audit",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
