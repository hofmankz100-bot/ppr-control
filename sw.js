const CACHE_NAME = "ppr-v382-qr-journal-restore";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=382-qr-journal-restore",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=382-qr-journal-restore",
  "./node_modules/mammoth/mammoth.browser.min.js?v=382-qr-journal-restore",
  "./modules/work-permit.js?v=382-qr-journal-restore",
  "./app.js?v=382-qr-journal-restore",
