const CACHE_NAME = "ppr-v695-admin-only-crane-preview-1";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v695-admin-only-crane-preview-1",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v695-admin-only-crane-preview-1",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v695-admin-only-crane-preview-1",
  "./node_modules/mammoth/mammoth.browser.min.js?v=421-annual-ppr-equipment-acts",
  "./modules/work-permit.js?v=658-cleanup",
  "./app.js?v=v695-admin-only-crane-preview-1",
  "./node_modules/jsqr/dist/jsQR.js?v=v695-admin-only-crane-preview-1",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
