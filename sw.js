const CACHE_NAME = "ppr-v576-dark-window-audit";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=v576-dark-window-audit",
  ...
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=v576-dark-window-audit",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=v576-dark-window-audit",
  ...
  "./app.js?v=v576-dark-window-audit",
  "./node_modules/jsqr/dist/jsQR.js?v=v576-dark-window-audit",
