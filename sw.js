const CACHE_NAME = "ppr-v368-admin-config-transfer";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=368-admin-config-transfer",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=368-admin-config-transfer",
  "./node_modules/mammoth/mammoth.browser.min.js?v=368-admin-config-transfer",
  "./modules/work-permit.js?v=368-admin-config-transfer",
  "./app.js?v=368-admin-config-transfer",
