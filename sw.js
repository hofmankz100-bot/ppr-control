const CACHE_NAME = "ppr-v420-annual-ppr-pdf-assets";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=420-annual-ppr-pdf-assets",
  ...
  "./node_modules/html2canvas/dist/html2canvas.min.js?v=420-annual-ppr-pdf-assets",
  "./node_modules/jspdf/dist/jspdf.umd.min.js?v=420-annual-ppr-pdf-assets",
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=420-annual-ppr-pdf-assets",
  "./node_modules/mammoth/mammoth.browser.min.js?v=420-annual-ppr-pdf-assets",
  "./modules/work-permit.js?v=420-annual-ppr-pdf-assets",
  "./app.js?v=420-annual-ppr-pdf-assets",
