const CACHE_NAME = "ppr-v827-repeat-kpd";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.min.css?v=v827-repeat-kpd",
  "./modules/repeat-failures.css?v=v827-repeat-kpd",
  "./modules/ppr-plan-editor.css?v=v827-repeat-kpd",
  "./modules/ppr-plan-editor.js?v=v827-repeat-kpd",
  "./modules/compressor.js?v=327-ppr-autofill-refresh",
  "./modules/shgrp.js?v=327-ppr-autofill-refresh",
  "./modules/receiver.js?v=288-print-request-pages",
  "./modules/comments.js?v=v827-repeat-kpd",
  "./modules/repeat-failures.js?v=v827-repeat-kpd",
  "./modules/aggregate-journal-view.js?v=v827-repeat-kpd",
  "./modules/director.js?v=v827-repeat-kpd",
  "./modules/print-assets.js?v=v827-repeat-kpd",
  "./modules/equipment-search.js?v=1",
  "./modules/device-cache-policy.js?v=v827-repeat-kpd",
  "./modules/photo-compression.js?v=v827-repeat-kpd",
  "./modules/attendance-entry.js?v=v827-repeat-kpd",
  "./app.min.js?v=v827-repeat-kpd",
  "./node_modules/jsqr/dist/jsQR.js?v=v827-repeat-kpd",
  "./manifest.json",
  "./icon.svg",
  "./icon-180.png",
  "./icon-192.png",
