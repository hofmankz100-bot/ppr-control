const CACHE_NAME = "ppr-v389-rating-cleanup";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=389-rating-cleanup",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=389-rating-cleanup",
  "./node_modules/mammoth/mammoth.browser.min.js?v=389-rating-cleanup",
  "./modules/work-permit.js?v=389-rating-cleanup",
  "./app.js?v=389-rating-cleanup",
