const CACHE_NAME = "ppr-v391-admin-rating-hide";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=391-admin-rating-hide",
  ...
  "./node_modules/html2pdf.js/dist/html2pdf.bundle.min.js?v=391-admin-rating-hide",
  "./node_modules/mammoth/mammoth.browser.min.js?v=391-admin-rating-hide",
  "./modules/work-permit.js?v=391-admin-rating-hide",
  "./app.js?v=391-admin-rating-hide",
