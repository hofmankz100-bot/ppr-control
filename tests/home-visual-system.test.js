...
test("narrow phones keep a readable product header", () => {
  ...
  assert.doesNotMatch(styles, /\.annual-ppr-act-dialog/);
...
test("dark theme uses a WhatsApp-inspired palette", () => {
  ...
  assert.match(styles, /html\[data-theme="dark"\] \.system-monitor-grid article/);
  assert.match(styles, /html\[data-theme="dark"\] \.admin-notification-policy/);
  assert.match(styles, /html\[data-theme="dark"\] \.admin-transfer-grid article/);
  assert.match(styles, /html\[data-theme="dark"\] \.admin-broadcast-list article/);
  assert.match(styles, /html\[data-theme="dark"\] \.admin-automation-status article/);
  assert.match(styles, /html\[data-theme="dark"\] \.admin-backup-list article/);
