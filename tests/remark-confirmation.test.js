...
test("admin and engineers can audit every rating point in a mobile-friendly ledger", () => {
  ...
  assert.match(html, /app\.js\?v=332-document-memo-access/);
  assert.match(html, /styles\.css\?v=332-document-memo-access/);
  assert.match(serviceWorker, /app\.js\?v=332-document-memo-access/);
});
