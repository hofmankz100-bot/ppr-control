...
test("admin and engineers can audit every rating point in a mobile-friendly ledger", () => {
  ...
  assert.match(html, /app\.js\?v=331-node-document-memo/);
  assert.match(html, /styles\.css\?v=331-node-document-memo/);
  assert.match(serviceWorker, /app\.js\?v=331-node-document-memo/);
});
