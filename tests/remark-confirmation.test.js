...
test("admin and engineers can audit every rating point in a mobile-friendly ledger", () => {
  ...
  assert.match(html, /app\.js\?v=318-finish-downtime-card/);
  assert.match(html, /styles\.css\?v=318-finish-downtime-card/);
  assert.match(serviceWorker, /app\.js\?v=318-finish-downtime-card/);
});
