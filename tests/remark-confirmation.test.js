...
test("admin and engineers can audit every rating point in a mobile-friendly ledger", () => {
  ...
  assert.match(html, /app\.js\?v=329-gpm-all-manual-entry/);
  assert.match(html, /styles\.css\?v=329-gpm-all-manual-entry/);
  assert.match(serviceWorker, /app\.js\?v=329-gpm-all-manual-entry/);
});
