...
test("admin and engineers can audit every rating point in a mobile-friendly ledger", () => {
  ...
  assert.match(html, /app\.js\?v=330-forklift-journal/);
  assert.match(html, /styles\.css\?v=330-forklift-journal/);
  assert.match(serviceWorker, /app\.js\?v=330-forklift-journal/);
});
