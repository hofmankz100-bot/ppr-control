  ...
  const db = {
    checks: {
      "1:0:2026-09-07": { to: { commentLog: [
        ...
        { ...resolvedRemark("duplicate-same-node", "2026-09-07T08:01:00.000Z", "2026-09-07T09:01:00.000Z"), type: "remark", role: "Оператор", authorKey: "phone:old-worker-1", photo: "data:image/jpeg;base64,copy" }
      ] } },
