...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=358-system-monitoring/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=358-system-monitoring/);
  assert.match(html, /modules\/work-permit\.js\?v=358-system-monitoring/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v358-system-monitoring/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=358-system-monitoring/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=358-system-monitoring/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=358-system-monitoring/);
  assert.match(serviceWorker, /styles\.css\?v=358-system-monitoring/);
  assert.match(serviceWorker, /app\.js\?v=358-system-monitoring/);
});
