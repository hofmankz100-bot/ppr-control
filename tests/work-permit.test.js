...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v529-forklift-shift-journal/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v529-forklift-shift-journal/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v529-forklift-shift-journal/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v529-forklift-shift-journal/);
  assert.match(serviceWorker, /app\.js\?v=v529-forklift-shift-journal/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v529-forklift-shift-journal/);
});
