...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v572-dark-mobile-nav/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v572-dark-mobile-nav/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v572-dark-mobile-nav/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v572-dark-mobile-nav/);
  assert.match(serviceWorker, /app\.js\?v=v572-dark-mobile-nav/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v572-dark-mobile-nav/);
});
