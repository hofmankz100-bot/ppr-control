...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=471-restore-gas-qr-nodes/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v471-restore-gas-qr-nodes/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=471-restore-gas-qr-nodes/);
