...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v504-ios-qr-camera/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=504-ios-qr-camera/);
  assert.match(serviceWorker, /app\.js\?v=504-ios-qr-camera/);
});
