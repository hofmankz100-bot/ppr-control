...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v583-dark-final-nested/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v583-dark-final-nested/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v583-dark-final-nested/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v583-dark-final-nested/);
  assert.match(serviceWorker, /app\.js\?v=v583-dark-final-nested/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v583-dark-final-nested/);
});
