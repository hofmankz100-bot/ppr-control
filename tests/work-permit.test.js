...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v566-installed-parts-mobile-swipes/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v566-installed-parts-mobile-swipes/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v566-installed-parts-mobile-swipes/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v566-installed-parts-mobile-swipes/);
  assert.match(serviceWorker, /app\.js\?v=v566-installed-parts-mobile-swipes/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v566-installed-parts-mobile-swipes/);
});
