...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=376-mobile-walk-counters/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=376-mobile-walk-counters/);
  assert.match(html, /modules\/work-permit\.js\?v=376-mobile-walk-counters/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v376-mobile-walk-counters/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=376-mobile-walk-counters/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=376-mobile-walk-counters/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=376-mobile-walk-counters/);
  assert.match(serviceWorker, /styles\.css\?v=376-mobile-walk-counters/);
  assert.match(serviceWorker, /app\.js\?v=376-mobile-walk-counters/);
});
