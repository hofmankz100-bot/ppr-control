...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v499-crane-qr-quick-result/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=499-crane-qr-quick-result/);
  assert.match(serviceWorker, /app\.js\?v=499-crane-qr-quick-result/);
});
