...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=402-shgrp-grp-qr/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=402-shgrp-grp-qr/);
  assert.match(html, /modules\/work-permit\.js\?v=402-shgrp-grp-qr/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v402-shgrp-grp-qr/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=402-shgrp-grp-qr/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=402-shgrp-grp-qr/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=402-shgrp-grp-qr/);
  assert.match(serviceWorker, /styles\.css\?v=402-shgrp-grp-qr/);
