...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v573-dark-journal-contrast/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v573-dark-journal-contrast/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v573-dark-journal-contrast/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v573-dark-journal-contrast/);
  assert.match(serviceWorker, /app\.js\?v=v573-dark-journal-contrast/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v573-dark-journal-contrast/);
});
