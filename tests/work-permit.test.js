...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v543-no-score-journal/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v543-no-score-journal/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v543-no-score-journal/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v543-no-score-journal/);
  assert.match(serviceWorker, /app\.js\?v=v543-no-score-journal/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v543-no-score-journal/);
});
