...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=400-admin-final/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=400-admin-final/);
  assert.match(html, /modules\/work-permit\.js\?v=400-admin-final/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v400-admin-final/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=400-admin-final/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=400-admin-final/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=400-admin-final/);
  assert.match(serviceWorker, /styles\.css\?v=400-admin-final/);
  assert.match(serviceWorker, /app\.js\?v=400-admin-final/);
});
