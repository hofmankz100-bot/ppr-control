...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=476-self-work-engineer-approval/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v476-self-work-engineer-approval/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=476-self-work-engineer-approval/);
  assert.match(serviceWorker, /styles\.css\?v=476-self-work-engineer-approval/);
  assert.match(serviceWorker, /app\.js\?v=476-self-work-engineer-approval/);
});
