...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=413-permanent-attendance-qr/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=413-permanent-attendance-qr/);
  assert.match(html, /modules\/work-permit\.js\?v=413-permanent-attendance-qr/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v413-permanent-attendance-qr/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=413-permanent-attendance-qr/);
