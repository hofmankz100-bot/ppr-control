...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v581-dark-reminder-calendar/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v581-dark-reminder-calendar/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v581-dark-reminder-calendar/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v581-dark-reminder-calendar/);
  assert.match(serviceWorker, /app\.js\?v=v581-dark-reminder-calendar/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v581-dark-reminder-calendar/);
});
