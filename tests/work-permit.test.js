...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=469-admin-tabs-lazy-load/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v469-admin-tabs-lazy-load/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=469-admin-tabs-lazy-load/);
  assert.match(serviceWorker, /styles\.css\?v=469-admin-tabs-lazy-load/);
