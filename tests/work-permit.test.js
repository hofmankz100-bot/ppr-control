...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v511-ios-native-qr-camera/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=511-ios-native-qr-camera/);
  assert.match(serviceWorker, /app\.js\?v=511-ios-native-qr-camera/);
});
