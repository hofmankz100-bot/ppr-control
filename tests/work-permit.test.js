...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=460-work-permit-single-sheet-fix/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v460-work-permit-single-sheet-fix/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=460-work-permit-single-sheet-fix/);
  assert.match(serviceWorker, /styles\.css\?v=460-work-permit-single-sheet-fix/);
