...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v533-rating-without-forklift-drivers/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v533-rating-without-forklift-drivers/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v533-rating-without-forklift-drivers/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v533-rating-without-forklift-drivers/);
  assert.match(serviceWorker, /app\.js\?v=v533-rating-without-forklift-drivers/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v533-rating-without-forklift-drivers/);
});
