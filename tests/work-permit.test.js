...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v580-dark-ppr-permit/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v580-dark-ppr-permit/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v580-dark-ppr-permit/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v580-dark-ppr-permit/);
  assert.match(serviceWorker, /app\.js\?v=v580-dark-ppr-permit/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v580-dark-ppr-permit/);
});
