...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=373-admin-catalogs/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=373-admin-catalogs/);
  assert.match(html, /modules\/work-permit\.js\?v=373-admin-catalogs/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v373-admin-catalogs/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=373-admin-catalogs/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=373-admin-catalogs/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=373-admin-catalogs/);
  assert.match(serviceWorker, /styles\.css\?v=373-admin-catalogs/);
