...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v517-crane-planned-maintenance-label/);
  ...
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v517-crane-planned-maintenance-label/);
});
