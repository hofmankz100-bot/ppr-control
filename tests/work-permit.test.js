...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v539-catalog-entity-sync/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v539-catalog-entity-sync/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v539-catalog-entity-sync/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v539-catalog-entity-sync/);
  assert.match(serviceWorker, /app\.js\?v=v539-catalog-entity-sync/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v539-catalog-entity-sync/);
});
