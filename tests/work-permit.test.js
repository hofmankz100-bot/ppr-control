...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=374-qr-routes/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=374-qr-routes/);
  assert.match(html, /modules\/work-permit\.js\?v=374-qr-routes/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v374-qr-routes/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=374-qr-routes/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=374-qr-routes/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=374-qr-routes/);
  assert.match(serviceWorker, /styles\.css\?v=374-qr-routes/);
