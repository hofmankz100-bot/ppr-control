...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v552-fast-admin-trash/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v552-fast-admin-trash/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v552-fast-admin-trash/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v552-fast-admin-trash/);
  assert.match(serviceWorker, /app\.js\?v=v552-fast-admin-trash/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v552-fast-admin-trash/);
});
