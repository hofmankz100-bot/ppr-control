...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v512-standard-crane-qr/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=512-standard-crane-qr/);
  assert.match(serviceWorker, /app\.js\?v=512-standard-crane-qr/);
});
