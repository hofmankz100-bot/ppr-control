...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=381-qr-walk-persist/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=381-qr-walk-persist/);
  assert.match(html, /modules\/work-permit\.js\?v=381-qr-walk-persist/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v381-qr-walk-persist/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=381-qr-walk-persist/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=381-qr-walk-persist/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=381-qr-walk-persist/);
  assert.match(serviceWorker, /styles\.css\?v=381-qr-walk-persist/);
