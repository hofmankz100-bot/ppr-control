...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=359-admin-editor/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=359-admin-editor/);
  assert.match(html, /modules\/work-permit\.js\?v=359-admin-editor/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v359-admin-editor/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=359-admin-editor/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=359-admin-editor/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=359-admin-editor/);
  assert.match(serviceWorker, /styles\.css\?v=359-admin-editor/);
  assert.match(serviceWorker, /app\.js\?v=359-admin-editor/);
});
