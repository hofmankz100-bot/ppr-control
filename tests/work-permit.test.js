...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v568-ui-style-system/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v568-ui-style-system/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v568-ui-style-system/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v568-ui-style-system/);
  assert.match(serviceWorker, /app\.js\?v=v568-ui-style-system/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v568-ui-style-system/);
});
