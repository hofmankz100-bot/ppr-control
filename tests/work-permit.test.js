...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v578-dark-operational-dialogs/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v578-dark-operational-dialogs/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v578-dark-operational-dialogs/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v578-dark-operational-dialogs/);
  assert.match(serviceWorker, /app\.js\?v=v578-dark-operational-dialogs/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v578-dark-operational-dialogs/);
});
