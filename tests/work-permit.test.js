...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=461-resolution-invitations/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v461-resolution-invitations/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=461-resolution-invitations/);
  assert.match(serviceWorker, /styles\.css\?v=461-resolution-invitations/);
