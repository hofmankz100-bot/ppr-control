...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=367-admin-system-report/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=367-admin-system-report/);
  assert.match(html, /modules\/work-permit\.js\?v=367-admin-system-report/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v367-admin-system-report/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=367-admin-system-report/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=367-admin-system-report/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=367-admin-system-report/);
  assert.match(serviceWorker, /styles\.css\?v=367-admin-system-report/);
  assert.match(serviceWorker, /app\.js\?v=367-admin-system-report/);
});
