...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=405-shgrp-protection-zone/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=405-shgrp-protection-zone/);
  assert.match(html, /modules\/work-permit\.js\?v=405-shgrp-protection-zone/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v405-shgrp-protection-zone/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=405-shgrp-protection-zone/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=405-shgrp-protection-zone/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=405-shgrp-protection-zone/);
  assert.match(serviceWorker, /styles\.css\?v=405-shgrp-protection-zone/);
