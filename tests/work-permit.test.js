...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v555-safe-pdf-filenames/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v555-safe-pdf-filenames/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v555-safe-pdf-filenames/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v555-safe-pdf-filenames/);
  assert.match(serviceWorker, /app\.js\?v=v555-safe-pdf-filenames/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v555-safe-pdf-filenames/);
});
