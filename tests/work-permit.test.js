...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v563-mobile-qr-journal-shops/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v563-mobile-qr-journal-shops/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v563-mobile-qr-journal-shops/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v563-mobile-qr-journal-shops/);
  assert.match(serviceWorker, /app\.js\?v=v563-mobile-qr-journal-shops/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v563-mobile-qr-journal-shops/);
});
