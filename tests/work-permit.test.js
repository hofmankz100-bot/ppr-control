...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v574-unified-dark-equipment/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v574-unified-dark-equipment/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v574-unified-dark-equipment/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v574-unified-dark-equipment/);
  assert.match(serviceWorker, /app\.js\?v=v574-unified-dark-equipment/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v574-unified-dark-equipment/);
});
