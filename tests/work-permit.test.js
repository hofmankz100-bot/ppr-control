...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v544-custom-journal-editor/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v544-custom-journal-editor/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v544-custom-journal-editor/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v544-custom-journal-editor/);
  assert.match(serviceWorker, /app\.js\?v=v544-custom-journal-editor/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v544-custom-journal-editor/);
});
