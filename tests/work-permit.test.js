...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v585-mobile-logo/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v585-mobile-logo/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v585-mobile-logo/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v585-mobile-logo/);
  assert.match(serviceWorker, /app\.js\?v=v585-mobile-logo/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v585-mobile-logo/);
});
