...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=466-private-month-close/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v466-private-month-close/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=466-private-month-close/);
  assert.match(serviceWorker, /styles\.css\?v=466-private-month-close/);
