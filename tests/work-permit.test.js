...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v546-journal-editor-polish/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v546-journal-editor-polish/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v546-journal-editor-polish/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v546-journal-editor-polish/);
  assert.match(serviceWorker, /app\.js\?v=v546-journal-editor-polish/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v546-journal-editor-polish/);
});
