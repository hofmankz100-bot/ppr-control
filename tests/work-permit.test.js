...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=406-shgrp-gas-point-recovery/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=406-shgrp-gas-point-recovery/);
  assert.match(html, /modules\/work-permit\.js\?v=406-shgrp-gas-point-recovery/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v406-shgrp-gas-point-recovery/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=406-shgrp-gas-point-recovery/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=406-shgrp-gas-point-recovery/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=406-shgrp-gas-point-recovery/);
  assert.match(serviceWorker, /styles\.css\?v=406-shgrp-gas-point-recovery/);
