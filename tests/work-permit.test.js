...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=401-admin-reliability/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=401-admin-reliability/);
  assert.match(html, /modules\/work-permit\.js\?v=401-admin-reliability/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v401-admin-reliability/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=401-admin-reliability/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=401-admin-reliability/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=401-admin-reliability/);
  assert.match(serviceWorker, /styles\.css\?v=401-admin-reliability/);
  assert.match(serviceWorker, /app\.js\?v=401-admin-reliability/);
});
