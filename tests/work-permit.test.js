...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v575-dark-production-work/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v575-dark-production-work/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v575-dark-production-work/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v575-dark-production-work/);
  assert.match(serviceWorker, /app\.js\?v=v575-dark-production-work/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v575-dark-production-work/);
});
