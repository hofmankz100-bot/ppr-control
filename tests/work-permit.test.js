...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=387-safe-node-delete/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=387-safe-node-delete/);
  assert.match(html, /modules\/work-permit\.js\?v=387-safe-node-delete/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v387-safe-node-delete/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=387-safe-node-delete/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=387-safe-node-delete/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=387-safe-node-delete/);
  assert.match(serviceWorker, /styles\.css\?v=387-safe-node-delete/);
