...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v577-dark-inner-panels/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v577-dark-inner-panels/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v577-dark-inner-panels/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v577-dark-inner-panels/);
  assert.match(serviceWorker, /app\.js\?v=v577-dark-inner-panels/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v577-dark-inner-panels/);
});
