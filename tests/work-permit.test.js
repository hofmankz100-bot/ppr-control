...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v569-mobile-action-contrast/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v569-mobile-action-contrast/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v569-mobile-action-contrast/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v569-mobile-action-contrast/);
  assert.match(serviceWorker, /app\.js\?v=v569-mobile-action-contrast/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v569-mobile-action-contrast/);
});
