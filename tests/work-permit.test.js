...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v564-mobile-journal-swipes/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v564-mobile-journal-swipes/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v564-mobile-journal-swipes/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v564-mobile-journal-swipes/);
  assert.match(serviceWorker, /app\.js\?v=v564-mobile-journal-swipes/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v564-mobile-journal-swipes/);
});
