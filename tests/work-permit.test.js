...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=357-admin-audit-trash/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=357-admin-audit-trash/);
  assert.match(html, /modules\/work-permit\.js\?v=357-admin-audit-trash/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v357-admin-audit-trash/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=357-admin-audit-trash/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=357-admin-audit-trash/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=357-admin-audit-trash/);
  assert.match(serviceWorker, /styles\.css\?v=357-admin-audit-trash/);
