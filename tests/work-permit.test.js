...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=404-shgrp-control-tubes/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=404-shgrp-control-tubes/);
  assert.match(html, /modules\/work-permit\.js\?v=404-shgrp-control-tubes/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v404-shgrp-control-tubes/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=404-shgrp-control-tubes/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=404-shgrp-control-tubes/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=404-shgrp-control-tubes/);
  assert.match(serviceWorker, /styles\.css\?v=404-shgrp-control-tubes/);
  assert.match(serviceWorker, /app\.js\?v=404-shgrp-control-tubes/);
});
