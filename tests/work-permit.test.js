...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=417-annual-ppr-pdf/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=417-annual-ppr-pdf/);
  assert.match(html, /modules\/work-permit\.js\?v=417-annual-ppr-pdf/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v417-annual-ppr-pdf/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=417-annual-ppr-pdf/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=417-annual-ppr-pdf/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=417-annual-ppr-pdf/);
  assert.match(serviceWorker, /styles\.css\?v=417-annual-ppr-pdf/);
