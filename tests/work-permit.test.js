...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v540-equipment-creation/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v540-equipment-creation/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v540-equipment-creation/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v540-equipment-creation/);
  assert.match(serviceWorker, /app\.js\?v=v540-equipment-creation/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v540-equipment-creation/);
});
