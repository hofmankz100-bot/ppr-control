...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=403-shgrp-grp-resolution/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=403-shgrp-grp-resolution/);
  assert.match(html, /modules\/work-permit\.js\?v=403-shgrp-grp-resolution/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v403-shgrp-grp-resolution/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=403-shgrp-grp-resolution/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=403-shgrp-grp-resolution/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=403-shgrp-grp-resolution/);
  assert.match(serviceWorker, /styles\.css\?v=403-shgrp-grp-resolution/);
