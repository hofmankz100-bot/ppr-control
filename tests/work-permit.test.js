...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=470-order-visibility/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v470-order-visibility/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=470-order-visibility/);
