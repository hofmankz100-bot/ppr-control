...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v518-stagger-crane-maintenance/);
  ...
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v518-stagger-crane-maintenance/);
});
