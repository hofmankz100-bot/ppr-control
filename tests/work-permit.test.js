...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /modules\/work-permit\.js\?v=472-rotatable-node-qr/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v472-rotatable-node-qr/);
  ...
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=472-rotatable-node-qr/);
