...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v545-journal-editor-ui/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v545-journal-editor-ui/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v545-journal-editor-ui/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v545-journal-editor-ui/);
  assert.match(serviceWorker, /app\.js\?v=v545-journal-editor-ui/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v545-journal-editor-ui/);
});
