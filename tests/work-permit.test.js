...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v491-monthly-crane-shift-journal/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=491-monthly-crane-shift-journal/);
  assert.match(serviceWorker, /app\.js\?v=491-monthly-crane-shift-journal/);
});
