...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v556-named-journal-pdfs/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v556-named-journal-pdfs/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v556-named-journal-pdfs/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v556-named-journal-pdfs/);
  assert.match(serviceWorker, /app\.js\?v=v556-named-journal-pdfs/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v556-named-journal-pdfs/);
});
