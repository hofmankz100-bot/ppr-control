...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v562-mobile-journals/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v562-mobile-journals/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v562-mobile-journals/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v562-mobile-journals/);
  assert.match(serviceWorker, /app\.js\?v=v562-mobile-journals/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v562-mobile-journals/);
});
