...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v519-stagger-after-cranes-load/);
  ...
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v519-stagger-after-cranes-load/);
});
