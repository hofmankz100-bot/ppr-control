...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=382-qr-journal-restore/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=382-qr-journal-restore/);
  assert.match(html, /modules\/work-permit\.js\?v=382-qr-journal-restore/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v382-qr-journal-restore/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=382-qr-journal-restore/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=382-qr-journal-restore/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=382-qr-journal-restore/);
  assert.match(serviceWorker, /styles\.css\?v=382-qr-journal-restore/);
