...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v584-dark-dialogs/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v584-dark-dialogs/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v584-dark-dialogs/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v584-dark-dialogs/);
  assert.match(serviceWorker, /app\.js\?v=v584-dark-dialogs/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v584-dark-dialogs/);
});
