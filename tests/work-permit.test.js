...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v557-qr-mobile-viewport/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v557-qr-mobile-viewport/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v557-qr-mobile-viewport/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v557-qr-mobile-viewport/);
  assert.match(serviceWorker, /app\.js\?v=v557-qr-mobile-viewport/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v557-qr-mobile-viewport/);
});
