...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v535-clean-rating-exclusions/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v535-clean-rating-exclusions/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v535-clean-rating-exclusions/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v535-clean-rating-exclusions/);
  assert.match(serviceWorker, /app\.js\?v=v535-clean-rating-exclusions/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v535-clean-rating-exclusions/);
});
