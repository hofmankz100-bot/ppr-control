...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v530-forklift-clean-form/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v530-forklift-clean-form/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v530-forklift-clean-form/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v530-forklift-clean-form/);
  assert.match(serviceWorker, /app\.js\?v=v530-forklift-clean-form/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v530-forklift-clean-form/);
});
