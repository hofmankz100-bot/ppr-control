...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=364-admin-archives/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=364-admin-archives/);
  assert.match(html, /modules\/work-permit\.js\?v=364-admin-archives/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v364-admin-archives/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=364-admin-archives/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=364-admin-archives/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=364-admin-archives/);
  assert.match(serviceWorker, /styles\.css\?v=364-admin-archives/);
  assert.match(serviceWorker, /app\.js\?v=364-admin-archives/);
});
