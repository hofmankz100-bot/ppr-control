...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v558-ios-whatsapp-pdf/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v558-ios-whatsapp-pdf/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v558-ios-whatsapp-pdf/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v558-ios-whatsapp-pdf/);
  assert.match(serviceWorker, /app\.js\?v=v558-ios-whatsapp-pdf/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v558-ios-whatsapp-pdf/);
});
