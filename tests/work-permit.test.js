...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v570-whatsapp-dark-theme/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v570-whatsapp-dark-theme/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v570-whatsapp-dark-theme/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v570-whatsapp-dark-theme/);
  assert.match(serviceWorker, /app\.js\?v=v570-whatsapp-dark-theme/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v570-whatsapp-dark-theme/);
});
