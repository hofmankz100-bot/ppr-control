...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v542-admin-equipment-removal/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v542-admin-equipment-removal/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v542-admin-equipment-removal/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v542-admin-equipment-removal/);
  assert.match(serviceWorker, /app\.js\?v=v542-admin-equipment-removal/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v542-admin-equipment-removal/);
});
