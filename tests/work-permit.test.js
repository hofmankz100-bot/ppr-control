...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v582-dark-deep-workflows/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v582-dark-deep-workflows/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v582-dark-deep-workflows/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v582-dark-deep-workflows/);
  assert.match(serviceWorker, /app\.js\?v=v582-dark-deep-workflows/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v582-dark-deep-workflows/);
});
