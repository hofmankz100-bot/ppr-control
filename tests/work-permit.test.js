...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=368-admin-config-transfer/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=368-admin-config-transfer/);
  assert.match(html, /modules\/work-permit\.js\?v=368-admin-config-transfer/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v368-admin-config-transfer/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=368-admin-config-transfer/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=368-admin-config-transfer/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=368-admin-config-transfer/);
  assert.match(serviceWorker, /styles\.css\?v=368-admin-config-transfer/);
  assert.match(serviceWorker, /app\.js\?v=368-admin-config-transfer/);
});
