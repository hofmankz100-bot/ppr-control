...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=370-notification-control/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=370-notification-control/);
  assert.match(html, /modules\/work-permit\.js\?v=370-notification-control/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v370-notification-control/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=370-notification-control/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=370-notification-control/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=370-notification-control/);
  assert.match(serviceWorker, /styles\.css\?v=370-notification-control/);
