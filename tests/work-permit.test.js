...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v510-isolated-crane-print/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=510-isolated-crane-print/);
  assert.match(serviceWorker, /app\.js\?v=510-isolated-crane-print/);
});
