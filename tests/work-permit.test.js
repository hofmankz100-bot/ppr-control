...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v586-dark-push/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v586-dark-push/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v586-dark-push/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v586-dark-push/);
  assert.match(serviceWorker, /app\.js\?v=v586-dark-push/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v586-dark-push/);
});
