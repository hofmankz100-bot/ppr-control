...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=409-shgrp-condensed-journal/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=409-shgrp-condensed-journal/);
  assert.match(html, /modules\/work-permit\.js\?v=409-shgrp-condensed-journal/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v409-shgrp-condensed-journal/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=409-shgrp-condensed-journal/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=409-shgrp-condensed-journal/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=409-shgrp-condensed-journal/);
  assert.match(serviceWorker, /styles\.css\?v=409-shgrp-condensed-journal/);
  assert.match(serviceWorker, /app\.js\?v=409-shgrp-condensed-journal/);
});
