...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v500-all-crane-qr-codes/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=500-all-crane-qr-codes/);
  assert.match(serviceWorker, /app\.js\?v=500-all-crane-qr-codes/);
});
