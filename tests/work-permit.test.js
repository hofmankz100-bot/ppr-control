...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=412-permit-ack-restore/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=412-permit-ack-restore/);
  assert.match(html, /modules\/work-permit\.js\?v=412-permit-ack-restore/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v412-permit-ack-restore/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=412-permit-ack-restore/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=412-permit-ack-restore/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=412-permit-ack-restore/);
  assert.match(serviceWorker, /styles\.css\?v=412-permit-ack-restore/);
  assert.match(serviceWorker, /app\.js\?v=412-permit-ack-restore/);
});
