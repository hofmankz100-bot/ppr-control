...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v489-official-crane-shift-journal/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=489-official-crane-shift-journal/);
  assert.match(serviceWorker, /app\.js\?v=489-official-crane-shift-journal/);
});
