...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v537-single-node-qr-print/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v537-single-node-qr-print/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v537-single-node-qr-print/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v537-single-node-qr-print/);
  assert.match(serviceWorker, /app\.js\?v=v537-single-node-qr-print/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v537-single-node-qr-print/);
});
