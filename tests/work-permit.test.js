...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v554-mobile-journal-share/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v554-mobile-journal-share/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v554-mobile-journal-share/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v554-mobile-journal-share/);
  assert.match(serviceWorker, /app\.js\?v=v554-mobile-journal-share/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v554-mobile-journal-share/);
});
