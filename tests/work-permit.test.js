...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v536-weekday-crane-maintenance/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v536-weekday-crane-maintenance/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v536-weekday-crane-maintenance/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v536-weekday-crane-maintenance/);
  assert.match(serviceWorker, /app\.js\?v=v536-weekday-crane-maintenance/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v536-weekday-crane-maintenance/);
});
