...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=391-admin-rating-hide/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=391-admin-rating-hide/);
  assert.match(html, /modules\/work-permit\.js\?v=391-admin-rating-hide/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v391-admin-rating-hide/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=391-admin-rating-hide/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=391-admin-rating-hide/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=391-admin-rating-hide/);
  assert.match(serviceWorker, /styles\.css\?v=391-admin-rating-hide/);
  assert.match(serviceWorker, /app\.js\?v=391-admin-rating-hide/);
});
