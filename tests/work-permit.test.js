...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v509-no-empty-print-page/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=509-no-empty-print-page/);
  assert.match(serviceWorker, /app\.js\?v=509-no-empty-print-page/);
});
