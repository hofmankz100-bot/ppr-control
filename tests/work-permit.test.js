...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=375-walk-counters/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=375-walk-counters/);
  assert.match(html, /modules\/work-permit\.js\?v=375-walk-counters/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v375-walk-counters/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=375-walk-counters/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=375-walk-counters/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=375-walk-counters/);
  assert.match(serviceWorker, /styles\.css\?v=375-walk-counters/);
  assert.match(serviceWorker, /app\.js\?v=375-walk-counters/);
});
