...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=369-admin-broadcasts/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=369-admin-broadcasts/);
  assert.match(html, /modules\/work-permit\.js\?v=369-admin-broadcasts/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v369-admin-broadcasts/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=369-admin-broadcasts/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=369-admin-broadcasts/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=369-admin-broadcasts/);
  assert.match(serviceWorker, /styles\.css\?v=369-admin-broadcasts/);
  assert.match(serviceWorker, /app\.js\?v=369-admin-broadcasts/);
});
