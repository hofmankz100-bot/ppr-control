...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=392-admin-guide/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=392-admin-guide/);
  assert.match(html, /modules\/work-permit\.js\?v=392-admin-guide/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v392-admin-guide/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=392-admin-guide/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=392-admin-guide/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=392-admin-guide/);
  assert.match(serviceWorker, /styles\.css\?v=392-admin-guide/);
  assert.match(serviceWorker, /app\.js\?v=392-admin-guide/);
});
