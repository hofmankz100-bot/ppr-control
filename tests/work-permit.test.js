...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v551-remove-organization-settings/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v551-remove-organization-settings/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v551-remove-organization-settings/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v551-remove-organization-settings/);
  assert.match(serviceWorker, /app\.js\?v=v551-remove-organization-settings/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v551-remove-organization-settings/);
});
