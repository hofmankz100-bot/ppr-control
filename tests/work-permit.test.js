...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v523-force-mobile-app-refresh/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=523-force-mobile-app-refresh/);
  assert.match(serviceWorker, /app\.js\?v=523-force-mobile-app-refresh/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v523-force-mobile-app-refresh/);
});
