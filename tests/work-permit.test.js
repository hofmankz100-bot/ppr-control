...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v492-crane-resolution-comment/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=492-crane-resolution-comment/);
  assert.match(serviceWorker, /app\.js\?v=492-crane-resolution-comment/);
});
