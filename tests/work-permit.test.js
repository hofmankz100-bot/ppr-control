...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=386-permit-button/);
  assert.match(html, /mammoth\.browser\.min\.js\?v=386-permit-button/);
  assert.match(html, /modules\/work-permit\.js\?v=386-permit-button/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v386-permit-button/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=386-permit-button/);
  assert.match(serviceWorker, /mammoth\.browser\.min\.js\?v=386-permit-button/);
  assert.match(serviceWorker, /modules\/work-permit\.js\?v=386-permit-button/);
  assert.match(serviceWorker, /styles\.css\?v=386-permit-button/);
