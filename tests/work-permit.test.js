...
test("work permit is available and loads its mobile PDF dependency", () => {
  ...
  assert.match(html, /html2pdf\.bundle\.min\.js\?v=v576-dark-window-audit/);
...
test("service worker caches the current permit assets", () => {
  assert.match(serviceWorker, /ppr-v576-dark-window-audit/);
  assert.match(serviceWorker, /html2pdf\.bundle\.min\.js\?v=v576-dark-window-audit/);
  ...
  assert.match(serviceWorker, /styles\.css\?v=v576-dark-window-audit/);
  assert.match(serviceWorker, /app\.js\?v=v576-dark-window-audit/);
  assert.match(serviceWorker, /node_modules\/jsqr\/dist\/jsQR\.js\?v=v576-dark-window-audit/);
});
