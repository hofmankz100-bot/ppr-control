...
const APP_VERSION = "v163-compressor-shgrp-logic";
...
function compressorJournalButtonStatus(area = COMPRESSOR_JOURNAL_AREA) {
  return compressorJournalHasIncompleteDueDays(area) ? "\u043d\u0435 \u0437\u0430\u043f\u043e\u043b\u043d\u0435\u043d\u043e" : "\u0432\u044b\u043f\u043e\u043b\u043d\u0435\u043d\u043e";
}
  ...
  ui.aggregateJournalList.innerHTML = `
    ...
    <div class="aggregate-journal-sheet compressor-journal-sheet" data-compressor-sheet="${activeSheetIndex}">
      <div class="aggregate-sheet-head">
        ...
        <button class="compressor-sheet-print" type="button" data-print-compressor-sheet="${activeSheetIndex}">\u041f\u0435\u0447\u0430\u0442\u044c \u043b\u0438\u0441\u0442\u0430 \u2116${activeSheetIndex + 1}</button>
      </div>
